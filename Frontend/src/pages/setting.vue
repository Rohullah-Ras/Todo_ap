<template>
  <div class="page">
    ...
    <div class="body">
      ...
      <main class="content">
        <!-- GENERAL -->
        <section v-if="activeTab === 'general'" class="card">
          <h2 class="h2">Theme</h2>

          <div class="themeRow">
            <div class="themeLabel">Light</div>
            <label class="switch">
              <input :checked="theme === 'light'" type="checkbox" @change="setTheme('light')"/>
              <span class="slider"></span>
            </label>
          </div>

          <div class="themeRow darkRow">
            <div class="themeLabel">Dark</div>
            <label class="switch">
              <input :checked="theme === 'dark'" type="checkbox" @change="setTheme('dark')"/>
              <span class="slider"></span>
            </label>
          </div>
        </section>

        <!-- USER (dit is jouw wireframe page) -->
        <section v-else-if="activeTab === 'user'" class="userWrap">
          <div class="userHero">
            <div class="avatarBig">👤</div>
          ...
          <div class="userForm">
            <div class="field">
              ...
              <div class="fieldLine">
                <input v-model="email" class="fieldInput" type="email"/>
            ...
            <div class="field">
              ...
              <div class="fieldLine">
                <input v-model="password" class="fieldInput" type="password"/>
                <span class="fieldIcon">🙈</span>
              </div>
            </div>
        ...
        <!-- ITEMS -->
        <section v-else-if="activeTab === 'items'" class="card">
          <h2 class="h2">Items & Lists</h2>
          <p class="p">Later: lists beheren, verwijderen, etc.</p>
        </section>

        <!-- WORKSPACE -->
        <section v-else class="card">
          <h2 class="h2">Work Space</h2>
          <p class="p">Later: spaces beheren, leden uitnodigen, etc.</p>
        </section>
      </main>
    </div>
  </div>
